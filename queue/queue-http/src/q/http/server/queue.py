...
def api(queue, timeout=15, Type=None, dump=lambda x: x, parse=Right): # type: ignore
  if Type is not None:
  ...
  return _api(queue, timeout=timeout, dump=dump, parse=parse)
